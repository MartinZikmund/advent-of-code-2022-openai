namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                // Create a temporary stack to hold the moved crates.
                ...
                // Pop the specified quantity of crates from the fromStack and push them onto the temporary stack.
                ...
                // Pop the crates from the temporary stack and push them onto the toStack, in reverse order so that they maintain their original order.
                while (tempStack.Any())
                {
                    stacks[step.Item3].Push(tempStack.Pop());
                }
            }
